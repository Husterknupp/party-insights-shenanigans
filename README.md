...
`POLITICIAN_TEMPLATES` constants in [`src/multiFieldApkg.js`](./src/multiFieldApkg.js) —
that's the single place to edit if the layout needs to change; `src/ankiExport.res` only
