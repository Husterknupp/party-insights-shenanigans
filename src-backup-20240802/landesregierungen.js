...
//   }
//   throw Error(
//     "Couldn't find relevant table with any of the names " +
//       nameOptions.toString()
//   );
// }
...
// function checkIsValid(amt, ministerName, party, imageUrl, urlCabinet) {
//   if (
//     amt === undefined ||
...
// function politicoScan(
//   html,
//   relevantTableNames,
//   columnNames /*{ amt, ministerName, party, image }*/,
// ) {
//   const cabinetName = findCabinetName(html);
//   const relevantTable = findRelevantTable(html, relevantTableNames);
...
//   const amtColumn = getAllCellsOfFirstColumnWithHeaderLike(
//     cells,
//     columnNames.amt,
//   );
...
//     const ministerName = getLastCellOfFirstColumnWithHeaderLike(
//       row,
//       columnNames.ministerName,
//     );
//     const party = getLastCellOfFirstColumnWithHeaderLike(
//       row,
//       columnNames.party,
//     );
//     const imageUrl = getLastCellOfFirstColumnWithHeaderLike(
//       row,
//       columnNames.image,
//     );
...
async function _extract(bundesland) {
  ...
  /* OR
    ...
    const result = politicianService.politicoScan(tableCells, columnNames)
      ...
    htmlService.cabinetName(response.data)
   */
  const { result, cabinetName } = politicoScan(
    response.data,
    [
      "Kabinett",
      "Landesregierung",
    ...
    {
      amt: ["amt", "ressort"],
      ministerName: ["amtsinhaber", "name"],
      party: ["partei", "parteien"],
      image: ["foto", "bild"],
    }
  );
